...
function edit_post($post_data = null)
{
    ...
    //creation post in Grodno's forum
    $postContent = $post->post_content;
    $postSubject = $post->post_title;
    PostCreator::create($postSubject, $postContent);
            ...
            if ($locked) {
                ...
                <div class="post-locked-message">
                    ...
                    <p class="currently-editing wp-tab-first"
                       tabindex="0"><?php echo esc_html(sprintf(__('This content is currently locked. If you take over, %s will be blocked from continuing to edit.'), $user->display_name)); ?></p>

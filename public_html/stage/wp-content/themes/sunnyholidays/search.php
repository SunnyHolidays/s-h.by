  ...
  <?php $search_result = tsearch();
    ...
    <article id="post-<?php echo $sr['id']; ?>" >
      ...
      <div class="post-content">
          ...
          <a href="/offer-details/?type=<?php echo $sr['api_id']; ?>&offer_id=<?php echo $sr['id']; ?>" class="button">Read more</a><?php //comments_popup_link('No comments', 'One comment', '% comments', 'button', 'Comments are closed'); ?>
      </div>
    </article>

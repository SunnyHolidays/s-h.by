...
<div id="gallery" class="two_columns">
  <ul class="portfolio">
    ...
    ?>
      ...
      <?php }else{ ?>
        <span class="image-border"><a class="image-wrap" href="<?php the_permalink() ?>" title="<?php _e('Permanent Link to', 'theme1404');?> <?php the_title_attribute(); ?>" ><?php the_post_thumbnail( 'portfolio-post-thumbnail-large' ); ?></a></span>
        <?php } ?>

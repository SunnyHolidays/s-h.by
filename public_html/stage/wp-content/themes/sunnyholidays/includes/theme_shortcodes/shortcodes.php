...
function shortcode_recenttesti($atts, $content = null) {
		...
		foreach($testi as $post){
				...
				$output .= '<div class="testi_item">';
						...
						$output .= '<blockquote><span class="inner">';
...
function shortcode_audio($atts, $content = null) {
    ...
    if($mp3 !== false){
        ...
        _e("The URL you entered is not a .mp3 file.", "theme1404");
...
function shortcode_video($atts, $content = null) {
    ...
    if($vimeo !== false){
        ...
        _e("You entered a video URL that isn't compatible with this shortcode.", "theme1404");

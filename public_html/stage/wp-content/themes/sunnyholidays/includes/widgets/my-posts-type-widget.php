...
function widget($args, $instance) {
  ...
  $cat_posts = new WP_Query(
	...
	?>
  	<?php if ($instance['posttype'] == "portfolio") {
      ...
      $testiurl = $custom["testimonial-url"][0];
		...
		<li class="cat_post_item-<?php echo $posts_counter; ?> clearfix">
            ...
            <?php if ( $instance['show_title'] ) : ?>
			  <?php echo $instance["before_post_title"]; ?><a class="post-title" href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php if ( $instance['show_title_date'] ) {?>[<?php the_time('m-d-Y'); ?>]<?php }else{?><span class="price"><?php echo $price; ?></span><?php the_title(); ?><?php }?></a><?php echo $instance["after_post_title"]; ?>
			<?php endif; ?>
            <div>

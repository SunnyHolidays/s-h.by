<?php /* Smarty version 2.6.11, created on 2013-06-11 15:56:42
         compiled from cache/modules/part_participants/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/part_participants/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/part_participants/DetailView.tpl', 38, false),array('function', 'sugar_getimagepath', 'cache/modules/part_participants/DetailView.tpl', 41, false),array('function', 'sugar_translate', 'cache/modules/part_participants/DetailView.tpl', 44, false),array('function', 'sugar_ajax_url', 'cache/modules/part_participants/DetailView.tpl', 209, false),array('modifier', 'strip_semicolon', 'cache/modules/part_participants/DetailView.tpl', 58, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='part_participants'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='part_participants'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='part_participants'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='part_participants'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['snamerus']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['snamerus']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['snamerus']['value']; ?>
</span>
<?php endif; ?>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['fnamerus']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_FNAMERUS','module' => 'part_participants'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['fnamerus']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['fnamerus']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['fnamerus']['value']; ?>
</span>
<?php endif; ?>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['mnamerus']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_MNAMERUS','module' => 'part_participants'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['mnamerus']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['mnamerus']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['mnamerus']['value']; ?>
</span>
<?php endif; ?>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['birthday']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (strlen ( $this->_tpl_vars['fields']['birthday']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['birthday']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['birthday']['value']);  endif; ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['birthday']['name']; ?>
...
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['part_participants_opportunities_name']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
"><?php endif; ?>
<span id="part_participants_opportunitiesopportunities_ida" class="sugar_field"><?php echo $this->_tpl_vars['fields']['part_participants_opportunities_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['part_participants_opportunitiesopportunities_ida']['value'] )): ?></a><?php endif;  endif; ?>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>

<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['adress_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ADRESS','module' => 'part_participants'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['adress_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['adress_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['adress_c']['value']; ?>
</span>
<?php endif; ?>
</td>
</tr>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['passport_num']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PASSPORT_NUM','module' => 'part_participants'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['passport_num']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['passport_num']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['passport_num']['value']; ?>
</span>
<?php endif; ?>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['passport_who']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PASSPORT_WHO','module' => 'part_participants'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%' colspan='3' >
<?php if (! $this->_tpl_vars['fields']['passport_who']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['passport_who']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['passport_who']['value']; ?>
</span>
<?php endif; ?>
</td>
</tr>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['passport_date']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PASSPORT_DATE','module' => 'part_participants'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['passport_date']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (strlen ( $this->_tpl_vars['fields']['passport_date']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['passport_date']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['passport_date']['value']);  endif; ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['passport_date']['name']; ?>
"><?php echo $this->_tpl_vars['value']; ?>
</span>
<?php endif; ?>
</td>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['passport_valid']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PASSPORT_VALID','module' => 'part_participants'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['passport_valid']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (strlen ( $this->_tpl_vars['fields']['passport_valid']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['passport_valid']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['passport_valid']['value']);  endif; ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['passport_valid']['name']; ?>
"><?php echo $this->_tpl_vars['value']; ?>
</span>
<?php endif; ?>
</td>

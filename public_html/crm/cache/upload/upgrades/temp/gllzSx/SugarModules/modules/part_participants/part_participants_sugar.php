 ...
 * PLACE ANY CUSTOMIZATIONS IN part_participants
 */

require_once('include/SugarObjects/templates/person/Person.php');

class part_participants_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'part_participants';
	var $object_name = 'part_participants';
	var $table_name = 'part_participants';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $passport_who;
		var $passport_valid;
		function part_participants_sugar(){	
		parent::Person();
	}

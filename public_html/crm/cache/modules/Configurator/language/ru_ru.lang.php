...
$mod_strings = array (
  ...
  'LBL_MIN_AUTO_REFRESH_INTERVAL_HELP' => 'Установка минимального итнервала автообновления раздела (дашлета). Выберите "Никогда", если необходимо отключить автоматическое обновление.',
...
<br><br>Load the metric file generated in step 2 and your font file below.',
  ...
  'LBL_WIZARD_WELCOME' => 'Нажмите на кнопку <b>Вперед</b> для настройки параметров системы. Если Вы хотите сделать это позже, нажмите на кнопку <b>Пропустить</b>.',

...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='search_name_basic' >{sugar_translate label='LBL_NAME' module='part_participants'}</label>
    	</td>
...
<input type='text' name='{$fields.search_name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='part_participants'}</label>
    	</td>

...
{html_options id='sales_stage_advanced' name='sales_stage_advanced[]' options=$fields.sales_stage_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.sales_stage_advanced.value}
   	   	</td>

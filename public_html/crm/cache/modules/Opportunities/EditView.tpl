...
>
<td valign="top" id='prepayment_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_PREPAYMENT' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.prepayment_c.value) <= 0}
{assign var="value" value=$fields.prepayment_c.default_value }
{else}
{assign var="value" value=$fields.prepayment_c.value }
{/if}  
<input type='text' name='{$fields.prepayment_c.name}' 
id='{$fields.prepayment_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_RATE' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
maxlength='255' 
value='{$value}' title=''      >
<td valign="top" id='amount_of_services_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_AMOUNT_OF_SERVICES' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.amount_of_services_c.value) <= 0}
{assign var="value" value=$fields.amount_of_services_c.default_value }
{else}
{assign var="value" value=$fields.amount_of_services_c.value }
{/if}  
<input type='text' name='{$fields.amount_of_services_c.name}' 
id='{$fields.amount_of_services_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{/literal}
{/if}
<td valign="top" id='full_payment_date_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_FULL_PAYMENT_DATE' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<span class="dateTime">
{assign var=date_value value=$fields.full_payment_date_c.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.full_payment_date_c.name}" id="{$fields.full_payment_date_c.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.full_payment_date_c.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.full_payment_date_c.name}",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.full_payment_date_c.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
startWeekday: {$CALENDAR_FDOW|default:'0'},
step : 1,
...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='date_contract_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_CONTRACT' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<span class="dateTime">
{assign var=date_value value=$fields.date_contract_c.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.date_contract_c.name}" id="{$fields.date_contract_c.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.date_contract_c.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.date_contract_c.name}",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.date_contract_c.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
startWeekday: {$CALENDAR_FDOW|default:'0'},
step : 1,
...
<td valign="top" id='contract_num_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_CONTRACT_NUM' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.contract_num_c.value) <= 0}
{assign var="value" value=$fields.contract_num_c.default_value }
{else}
{assign var="value" value=$fields.contract_num_c.value }
{/if}  
<input type='text' name='{$fields.contract_num_c.name}' 
id='{$fields.contract_num_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
maxlength='100' 
value='{$value}' title=''      >
<td valign="top" id='next_step_date_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_NEXT_STEP_DATE' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
<span class="dateTime">
{assign var=date_value value=$fields.next_step_date_c.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.next_step_date_c.name}" id="{$fields.next_step_date_c.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.next_step_date_c.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.next_step_date_c.name}",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.next_step_date_c.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
startWeekday: {$CALENDAR_FDOW|default:'0'},
step : 1,
...
{/literal}
{/if}
<td valign="top" id='resort_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_RESORT' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.resort_c.value) <= 0}
{assign var="value" value=$fields.resort_c.default_value }
{else}
{assign var="value" value=$fields.resort_c.value }
{/if}  
<input type='text' name='{$fields.resort_c.name}' 
id='{$fields.resort_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='airport_dep_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_AIRPORT_DEP' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.airport_dep_c.value) <= 0}
{assign var="value" value=$fields.airport_dep_c.default_value }
{else}
{assign var="value" value=$fields.airport_dep_c.value }
{/if}  
<input type='text' name='{$fields.airport_dep_c.name}' 
id='{$fields.airport_dep_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
<td valign="top" id='airport_des_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_AIRPORT_DES' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.airport_des_c.value) <= 0}
{assign var="value" value=$fields.airport_des_c.default_value }
{else}
{assign var="value" value=$fields.airport_des_c.value }
{/if}  
<input type='text' name='{$fields.airport_des_c.name}' 
id='{$fields.airport_des_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='date_start_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_START' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<td valign="top" id='date_end_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_END' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='hotel_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_HOTEL' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.hotel_c.value) <= 0}
{assign var="value" value=$fields.hotel_c.default_value }
{else}
{assign var="value" value=$fields.hotel_c.value }
{/if}  
<input type='text' name='{$fields.hotel_c.name}' 
id='{$fields.hotel_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
<td valign="top" id='hotel_room_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_HOTEL_ROOM' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.hotel_room_c.value) <= 0}
{assign var="value" value=$fields.hotel_room_c.default_value }
{else}
{assign var="value" value=$fields.hotel_room_c.value }
{/if}  
<input type='text' name='{$fields.hotel_room_c.name}' 
id='{$fields.hotel_room_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='food_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_FOOD' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.food_c.name}" 
id="{$fields.food_c.name}" 
title=''       
>
{if isset($fields.food_c.value) && $fields.food_c.value != ''}
{html_options options=$fields.food_c.options selected=$fields.food_c.value}
{else}
{html_options options=$fields.food_c.options selected=$fields.food_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.food_c.options }
{capture name="field_val"}{$fields.food_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.food_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.food_c.name}" 
id="{$fields.food_c.name}" 
title=''          
>
{if isset($fields.food_c.value) && $fields.food_c.value != ''}
...
<input
id="{$fields.food_c.name}-input"
name="{$fields.food_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.food_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.food_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.food_c.name}-input', '{$fields.food_c.name}');sync_{$fields.food_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.food_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.food_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.food_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.food_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.food_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.food_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.food_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.food_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.food_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
addToValidate('EditView', 'next_step_date_c', 'date', true,'{/literal}{sugar_translate label='LBL_NEXT_STEP_DATE' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'country_c', 'enum', false,'{/literal}{sugar_translate label='LBL_COUNTRY' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'resort_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_RESORT' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'airport_dep_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AIRPORT_DEP' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'airport_des_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AIRPORT_DES' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'date_start_c', 'date', false,'{/literal}{sugar_translate label='LBL_DATE_START' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'hotel_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_HOTEL' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'food_c', 'enum', false,'{/literal}{sugar_translate label='LBL_FOOD' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'date_end_c', 'date', false,'{/literal}{sugar_translate label='LBL_DATE_END' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'rate_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_RATE' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'amount_of_services_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AMOUNT_OF_SERVICES' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'prepayment_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_PREPAYMENT' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'hotel_room_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_HOTEL_ROOM' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'full_payment_date_c', 'date', false,'{/literal}{sugar_translate label='LBL_FULL_PAYMENT_DATE' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'date_contract_c', 'date', false,'{/literal}{sugar_translate label='LBL_DATE_CONTRACT' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'contract_num_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CONTRACT_NUM' module='Opportunities' for_js=true}{literal}' );

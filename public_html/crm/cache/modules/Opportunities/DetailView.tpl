...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.full_payment_date_c.hidden}
...
{if strlen($fields.full_payment_date_c.value) <= 0}
{assign var="value" value=$fields.full_payment_date_c.default_value }
{else}
{assign var="value" value=$fields.full_payment_date_c.value }
{/if}
<span class="sugar_field" id="{$fields.full_payment_date_c.name}">{$value}</span>
{/if}
</td>
</tr>
{/capture}
...
{/if} 
<span class="sugar_field" id="{$fields.prepayment_c.name}">{$fields.prepayment_c.value}</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.amount_of_services_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.amount_of_services_c.name}">{$fields.amount_of_services_c.value}</span>
{/if}
</td>
</tr>
{/capture}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.date_contract_c.hidden}
...
{if strlen($fields.date_contract_c.value) <= 0}
{assign var="value" value=$fields.date_contract_c.default_value }
{else}
{assign var="value" value=$fields.date_contract_c.value }
{/if}
<span class="sugar_field" id="{$fields.date_contract_c.name}">{$value}</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.contract_num_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.contract_num_c.name}">{$fields.contract_num_c.value}</span>
{/if}
</td>
</tr>
{/capture}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.next_step_date_c.hidden}
...
{if strlen($fields.next_step_date_c.value) <= 0}
{assign var="value" value=$fields.next_step_date_c.default_value }
{else}
{assign var="value" value=$fields.next_step_date_c.value }
{/if}
<span class="sugar_field" id="{$fields.next_step_date_c.name}">{$value}</span>
{/if}
</td>
</tr>
{/capture}
...
{/if} 
<span class="sugar_field" id="{$fields.resort_c.name}">{$fields.resort_c.value}</span>
{/if}
</td>
</tr>
{/capture}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.airport_dep_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.airport_dep_c.name}">{$fields.airport_dep_c.value}</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.airport_des_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.airport_des_c.name}">{$fields.airport_des_c.value}</span>
{/if}
</td>
</tr>
{/capture}
...
{/if} 
<span class="sugar_field" id="{$fields.hotel_c.name}">{$fields.hotel_c.value}</span>
{/if}
</td>
</tr>
{/capture}
...
{/if} 
<span class="sugar_field" id="{$fields.hotel_room_c.name}">{$fields.hotel_room_c.value}</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.food_c.hidden}
...
{if is_string($fields.food_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.food_c.name}" value="{ $fields.food_c.options }">
{ $fields.food_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.food_c.name}" value="{ $fields.food_c.value }">
{ $fields.food_c.options[$fields.food_c.value]}
{/if}
{/if}
</td>
</tr>

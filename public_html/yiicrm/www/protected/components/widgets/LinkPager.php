...
class LinkPager extends CBasePager
{
    ...
    const CSS_HIDDEN_PAGE='first ui-corner-tl ui-corner-bl fg-button ui-button ui-state-default ui-state-disabled';
    const CSS_SELECTED_PAGE='selected fg-button ui-button ui-state-default ui-state-disabled';
    ...
    public function init()
    {
        ...
        if(!isset($this->htmlOptions['class']))
            $this->htmlOptions['class']=' yiiPager dataTables_paginate fg-buttonset ui-buttonset fg-buttonset-multi ui-buttonset-multi';
    }
    ...
    protected function createPageButton($label,$page,$class,$hidden,$selected)
    {
        if($hidden || $selected){
            ...
            return CHtml::link($label,'javascript:void(0)', array('class'=>$class));
        }
        else{

...
class MailTemplates extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('alias, title, from, email, subject, body, body_text, tags', 'required'),
            array('email', 'email'),
            array('alias, title, from, email, subject, tags', 'length', 'max' => 255),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, alias, title, from, email, subject, body, body_text, tags', 'safe', 'on' => 'search'),
        );
    }

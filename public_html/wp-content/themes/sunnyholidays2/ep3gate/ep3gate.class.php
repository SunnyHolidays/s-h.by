...
class ep3gate {
  ...
  {
    if(($key=array_search('bookmarks', $params))!==FALSE)
      $adtparams .= '&ep3_bookmarks='.$_COOKIE['ep3_bookmarks'];
...
if(isset($_GET['easypaxversion']))
{
  ?><pre>
  /**
    * @version: $Id: ep3gate.class.php 1965 2013-08-27 15:42:30Z danielf $
    *
    * @prevversion: $Id: ep3gate.class.php 1965 2010-06-02 10:47:35Z zbyszekb $
    * @version: PHP 5
    */
  </pre><?php
}
